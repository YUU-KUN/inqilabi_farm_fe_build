...
export default {
  ...
  methods: {
    ...
    editReport() {
      ...
      //     foto: this.foto,
      //     filename: this.foto.upload.filename
      //   }
      // } else if (this.report.proses == 'penyembelihan') {
      //   this.formData = {
      ...
      // } else if (this.report.proses == 'pengiriman') {
      //   this.formData = {
      //     supir: this.report.supir,
      //     no_supir: this.report.no_supir,
      //     mobil_pengirim: this.report.mobil_pengirim,
      //     foto: this.foto,
      //     filename: this.foto.upload.filename
      //   }
      // } else {
      //   this.formData = {
      //     penerima: this.report.penerima,
      //     hari_diterima: this.report.hari_diterima,
      //     pukul_diterima: this.report.pukul_diterima,
      //     foto: this.foto,
      //     filename: this.foto.upload.filename
      //   }
      // }
